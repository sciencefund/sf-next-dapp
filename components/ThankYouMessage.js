...
export default function ThankYouMessage(props) {
    const { txhash, account, sftContract, close } = props
        ...
        <ModalDisplayScreen close={close}>
            <div className='my-10 max-w-lg mx-auto text-center'>
                ...
                <div className="my-10 h-24">
                    ...
                    <p className="text-sm w-4/5 mx-auto"> The transaction is sent successfully. Here is your transaction hash <a href="/" className="text-blue-900 text-sm">{txhash}</a> on Etherscan.io</p>
                </div>
